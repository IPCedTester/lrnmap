  ...
  this.FilmRoll = (function() {
    ...
    FilmRoll.prototype.configure = function() {
      ...
      if (!(this.options.no_css === true || document.film_roll_styles_added)) {
        $("<style type='text/css'> .film_roll_wrapper{display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:80%;margin:0 !important;padding:0 !important;overflow:hidden;} .film_roll_shuttle{text-align:left;float:none;position:relative;top:0;left:0;right:auto;bottom:auto;height:60%;margin:0 !important;padding:0 !important;z-index:auto;} .film_roll_shuttle.vertical_center:before{content:'';display:inline-block;height:100%;vertical-align:middle;margin-right:-0.25em;} .film_roll_child{position:relative;display:inline-block;*display:inline;vertical-align:middle;zoom:1;} .film_roll_prev{position:relative;float:left;left:15px;width:20px;height:40px;margin:0 0 0 0;padding:0;font-size:60px;font-weight:100;line-height:30px;color:white;text-align:center;background:#222;border:3px solid white;border-radius:23px;opacity:0.5} .film_roll_next{position:absolute;float:right;left:15px;width:auto;height:40px;margin:-20px 0 0 0;padding:0;font-size:60px;font-weight:100;line-height:30px;color:white;text-align:center;background:#222;border:3px solid white;border-radius:23px;opacity:0.5}.film_roll_prev:hover{color:white;text-decoration:none;opacity:0.9}.film_roll_next:hover{color:white;text-decoration:none;opacity:0.9} .film_roll_next{left:auto;right:15px} .film_roll_pager{text-align:center;} .film_roll_pager a{width:5px;height:5px;border:2px solid #333;border-radius:5px;display:inline-block;margin:0 5px 0 0;transition:all 1s ease} .film_roll_pager a:hover{background:#666} .film_roll_pager a.active{background:#333} .film_roll_pager span{display:none} .film_roll_pager a,a.film_roll_prev,a.film_roll_next{-webkit-box-sizing: content-box;-moz-box-sizing: content-box;box-sizing: content-box;} </style>").appendTo('head');
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_prev" href="#" style="width:60px;font-size:60px;">&lsaquo;</a>');
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.append('<a class="film_roll_next" href="#" style="width:60px;font-size:60px;">&rsaquo;</a>');
